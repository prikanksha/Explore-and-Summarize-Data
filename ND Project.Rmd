...
###This report explores a dataset containing 11 chemical characteristics beside a quality from 1 to 10 from at least 3 wine experts for 1599 different wines to do a binary classification of good wine and not-so-good wine.
...
#Viewing few starting rows of the dataset
head(wine)
...
###All the variables/column names in the dataset are:
...
3. Citric acid has large number of zero values. I wonder if this is due to incomplete data entry.
...
2. The variables most strongly correlated to quality are Volatile Acidity and Alcohol.

3. Alcohol has negative correlation with density. This is evident from the fact that the density of water is greater than the density of alcohol.
...
4. Better wines seem to be more acidic.
5. Residual sugar almost has no effect on the wine quality.
